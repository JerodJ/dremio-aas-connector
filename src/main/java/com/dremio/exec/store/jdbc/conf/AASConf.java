...
@SourceType(value = "AASARP", label = "AAS",uiConfig = "aas-layout.json")
public class AASConf extends AbstractArpConf<AASConf> {
  private static final String ARP_FILENAME = "arp/implementation/aas-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.aas.AASDriver";
